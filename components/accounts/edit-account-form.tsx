...
export const EditAccountForm = ({ account }: Props) => {
  ...
  const form = useForm<AccountFormValues>({
    ...
    defaultValues: {
      ...
      status: account.student?.status || StudentStatus.AWAITING,
    },
  });
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Cập nhật thông tin tài khoản</p>
        </div>
      </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Nhập email" type="email" {...field} disabled />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
