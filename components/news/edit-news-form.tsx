...
import { updateNews } from "@/action/news";
...
import { NewsType, News } from "@prisma/client";
...
export const EditNewsForm = ({ news }: Props) => {
  ...
  const [preview, setPreview] = useState<string | null>(news.cover || null);
  ...
  const onSubmit = async (data: EditNewsFormValues, publish: boolean) => {
    setIsLoading(true);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold">Chỉnh sửa tin tức</h2>
